...
pub const SHARED_TYPES: &[&str] = &[
    ...
    "struct winsize { ws_row: c_ushort, ws_col: c_ushort, ws_xpixel: c_ushort, \
     ws_ypixel: c_ushort }",
...
pub const HEADERS: &[HeaderSpec] = &[
    ...
    HeaderSpec {
        path: "fenv.h",
        summary: "the floating-point environment",
        includes: &[],
        types: &["fexcept_t", "fenv_t"],
        consts: &["FE_*"],
        slibc_consts: &[],
        macros: &[],
        functions: &[
    ...
    HeaderSpec {
        ...
        extra: &[
            ...
            "strpbrk(s: *const c_char, accept: *const c_char) -> *mut c_char",
            "strtok(s: *mut c_char, delim: *const c_char) -> *mut c_char",
            "strtok_r(s: *mut c_char, delim: *const c_char, save: *mut *mut c_char) -> *mut c_char",
        ],
        variables: &[],
        raw: &[],
        raw_unguarded: &[],
    ...
    HeaderSpec {
        ...
        includes: &[],
        types: &[],
        // Exact names: `<fcntl.h>` owns the `AT_*` prefix for the `*at` flags.
        consts: &[
            "AT_NULL",
            "AT_IGNORE",
            "AT_EXECFD",
    ...
    HeaderSpec {
        ...
        consts: &[
            ...
            "TCSBRK", "TCXONC", "TCFLSH", "TCSBRKP", "TCGETS2", "TCSETS2", "TCSETSW2", "TCSETSF2",
            "TIOC*", "FION*", "FIOCLEX", "FIONCLEX",
        ],
        slibc_consts: &[],
        macros: &[],
        functions: &["ioctl"],
    ...
    HeaderSpec {
        path: "spawn.h",
        summary: "process spawning",
        includes: &["sys/types.h", "signal.h", "sched.h"],
        types: &["posix_spawnattr_t", "posix_spawn_file_actions_t"],
        consts: &["POSIX_SPAWN_*"],
        slibc_consts: &[],
        macros: &[],
        functions: &[
