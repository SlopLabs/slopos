...
crate::utest!(name = utest_buildloop, bin = "/bin/buildloop_test");
crate::utest!(name = utest_exit_stress, bin = "/bin/exit_stress_test");
crate::utest!(
...
crate::utest!(name = utest_selfhost, bin = "/bin/selfhost_test");
