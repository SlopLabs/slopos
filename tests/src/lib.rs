...
mod suites {
    ...
    use slopos_core::sched_tests::{
        ...
        test_schedule_null_task, test_schedule_task_before_scheduler_enable_on_current_cpu,
    ...
    use slopos_mm::tlb_tests::{
        ...
        test_batch_scattered_addresses, test_batch_single_page, test_bsp_apic_id_from_percpu,
        test_flush_all_basic, test_flush_asid_kernel_cr3, test_flush_asid_zero,
        test_flush_page_high_kernel_address, test_flush_page_kernel_address,
        test_flush_page_null_address, test_flush_page_user_max_address, test_flush_range_empty,
        test_flush_range_inverted, test_flush_range_large, test_flush_range_single_page,
        test_flush_range_threshold_boundary, test_flush_type_from_invalid,
        test_flush_type_from_valid, test_get_active_cpu_count,
        ...
        test_rapid_flush_all, test_rapid_flush_pages, test_tlb_shootdown_vector_valid,
    };
