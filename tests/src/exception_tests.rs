...
pub fn test_exception_names_valid() -> TestResult {
...
pub fn test_critical_exception_classification() -> TestResult {
...
pub fn test_page_fault_error_codes() -> TestResult {
...
pub fn test_frame_mode_detection() -> TestResult {
...
pub fn test_frame_invalid_cs() -> TestResult {
...
pub fn test_frame_noncanonical_addresses() -> TestResult {
...
pub fn test_exception_names_all_vectors() -> TestResult {
...
pub fn test_vector_boundaries() -> TestResult {
...
pub fn test_error_code_preservation() -> TestResult {
...
pub fn test_frame_integrity_patterns() -> TestResult {
    let mut frame = create_test_frame(14, true);
...
pub fn test_known_exception_names() -> TestResult {
    let expected = [
        (0, "Divide Error"),
        (1, "Debug"),
