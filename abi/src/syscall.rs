...
/// Interrupt signal — generated by Ctrl+C (VINTR).
pub const SIGINT: u8 = 2;
pub const SIGHUP: u8 = 1;
/// Quit signal — generated by Ctrl+\\ (VQUIT).  Typically produces a core dump.
pub const SIGQUIT: u8 = 3;
pub const SIGCONT: u8 = 18;
/// Terminal stop signal — generated by Ctrl+Z (VSUSP).
